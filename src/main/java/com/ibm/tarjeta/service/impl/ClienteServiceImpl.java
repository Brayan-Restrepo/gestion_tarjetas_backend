...
public class ClienteServiceImpl implements ClienteService {
	...
	public List<ClienteDto> findAll() {
		List<Cliente> aveList = (List<Cliente>) this.clienteRepository.findAll();		
		return aveList.stream().map(cliente -> modelMapper.map(cliente, ClienteDto.class)).collect(Collectors.toList());
	}
